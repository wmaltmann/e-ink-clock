...
class TonePlayer:
    def __init__(self, frequency=440, duration_sec=4, amplitude=32767 // 4,
        ...
        self.duty_cycle = duty_cycle  # percent (0-100)
        self.period = period          # seconds (total beep cycle)
        self.ramp = ramp
    ...
    async def _play_tone_async(self):
        ...
        while self.enabled and time.ticks_ms() < end_time:
            ...
            self._enable_left.value(1)
            self._enable_right.value(1)
